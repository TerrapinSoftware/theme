    ...
    return function e(t, n, r) {
            ...
            function i(e) {
                ...
                e.codeMirrorInstance.defineMode("spell-checker", (function(t) {
                    if (!i.aff_loading) {
                        ...
                        n.onload = function() {
                            4 === n.readyState && 200 === n.status && (i.aff_data = n.responseText,
                            i.num_loaded++,
                            2 == i.num_loaded && (i.typo = new r("en_US",i.aff_data,i.dic_data,{
                                platform: "any"
                            })))
                        }
                        ,
                    ...
                    if (!i.dic_loading) {
                        ...
                        o.onload = function() {
                            4 === o.readyState && 200 === o.status && (i.dic_data = o.responseText,
                            i.num_loaded++,
                            2 == i.num_loaded && (i.typo = new r("en_US",i.aff_data,i.dic_data,{
                                platform: "any"
                            })))
                ...
                e.overlayMode = function(t, n, r) {
                    return {
                        ...
                        blankLine: function(e) {
                            var i, o;
                            return t.blankLine && (i = t.blankLine(e.base)),
        ...
        7: [function(e, t, n) {
            (function(e) {
                ...
                function p(e, t, n, o) {
                    ...
                    o && !1 === o.multiline ? this.matches = function(n, r) {
                        return (n ? u : a)(e, t, r)
                    }
                    : this.matches = function(n, r) {
                        return (n ? c : l)(e, t, r)
                ...
                function t(e) {
                    e.state.markedSelection && e.operation((function() {
                        !function(e) {
                            ...
                            var s = r[0].find()
                              , u = r[r.length - 1].find();
                            if (!s || !u || n.line - t.line <= 8 || i(t, u.to) >= 0 || i(n, s.from) <= 0)
                                return l(e);
                            for (; i(t, s.from) > 0; )
                                r.shift().clear(),
                                s = r[0].find();
                            for (i(t, s.from) < 0 && (s.to.line - t.line < 8 ? (r.shift().clear(),
                            o(e, t, s.to, 0)) : o(e, t, s.from, 0)); i(n, u.to) < 0; )
                                r.pop().clear(),
                                u = r[r.length - 1].find();
                            i(n, u.to) > 0 && (n.line - u.from.line < 8 ? (r.pop().clear(),
        ...
        9: [function(e, t, n) {
            !function(e, r) {
                ...
                function Y(e, t) {
                    var n;
                    return Object.create ? n = Object.create(e) : (Z.prototype = e,
                    n = new Z),
                    t && P(t, n),
                    n
                }
                ...
                var se = function() {
                    ...
                    return function(a, l) {
                        ...
                        for (var y = 1, b = d[0]; y < c - 1; ++y) {
                            var w = d[y];
                            "+" == w && "1" == b && "1" == d[y + 1] ? d[y] = "1" : "," != w || b != d[y + 1] || "1" != b && "n" != b || (d[y] = b),
                            b = w
                        }
                        for (var k = 0; k < c; ++k) {
                            var C = d[k];
                            if ("," == C)
                                ...
                                for (S = k + 1; S < c && "%" == d[S]; ++S)
                                    ;
                                for (var L = k && "!" == d[k - 1] || S < c && "1" == d[S] ? "1" : "N", T = k; T < S; ++T)
                                    d[T] = L;
                                k = S - 1
                            }
                        }
                        for (var M = 0, N = s; M < c; ++M) {
                            var A = d[M];
                            "L" == N && "1" == A ? d[M] = "L" : n.test(A) && (N = A)
                        }
                        for (var D = 0; D < c; ++D)
                            if (t.test(d[D])) {
                                var F = void 0;
                                for (F = D + 1; F < c && t.test(d[F]); ++F)
                                    ;
                                for (var E = "L" == (D ? d[D - 1] : s), O = E == ("L" == (F < c ? d[F] : s)) ? E ? "L" : "R" : s, I = D; I < F; ++I)
                                    d[I] = O;
                                D = F - 1
                            }
                        for (var z, H = [], P = 0; P < c; )
                            if (r.test(d[P])) {
                                ...
                                for (var j = W; j < P; )
                                    if (i.test(d[j])) {
                                        W < j && (H.splice(_, 0, new o(1,W,j)),
                                        _ += B);
                                        var q = j;
                                        for (++j; j < P && i.test(d[j]); ++j)
                                            ;
                                        H.splice(_, 0, new o(2,q,j)),
                                        _ += B,
                                        W = j
                                    } else
                                        ++j;
                                W < P && H.splice(_, 0, new o(1,W,P))
                            }
                        return "ltr" == l && (1 == H[0].level && (z = a.match(/^\s+/)) && (H[0].from = z[0].length,
                        H.unshift(new o(0,0,z[0].length))),
                        1 == K(H).level && (z = a.match(/\s+$/)) && (K(H).to -= z[0].length,
                        H.push(new o(0,c - z[0].length,c)))),
                        "rtl" == l ? H.reverse() : H
                    }
                }();
                function ue(e, t) {
                    var n = e.order;
                    return null == n && (n = e.order = se(e.text, t)),
                    n
                }
                var ce = []
                  , de = function(e, t, n) {
                ...
                function Ne(e) {
                    if (null == Le) {
                        ...
                        0 != e.firstChild.offsetHeight && (Le = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(a && l < 8))
                    }
                    var n = Le ? A("span", "​") : A("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
                ...
                function Ae(e) {
                    ...
                    return M(e),
                    !(!n || n.left == n.right) && (Te = r.right - n.right < 3)
                }
                var De, Fe = 3 != "\n\nb".split(/\n/).length ? function(e) {
                ...
                , Oe = "oncopy"in (De = A("div")) || (De.setAttribute("oncopy", "return;"),
                "function" == typeof De.oncopy), Ie = null;
                var ze = {}
                  , He = {};
                function Pe(e, t) {
                ...
                function Re(e) {
                    if ("string" == typeof e && He.hasOwnProperty(e))
                        e = He[e];
                ...
                var _e = {};
                function Be(e, t) {
                    P(t, _e.hasOwnProperty(e) ? _e[e] : _e[e] = {})
                }
                function je(e, t) {
                    if (!0 === t)
                        return t;
                ...
                function Ze(e) {
                    if (null == e.parent)
                        return null;
                    for (var t = e.parent, n = _(t.lines, e), r = t.parent; r; t = r,
                    r = r.parent)
                ...
                $e.prototype.column = function() {
                    return this.lastColumnPos < this.start && (this.lastColumnValue = R(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue),
                ...
                function dt(e, t, n, r) {
                    ...
                    for (var a = n.state, l = function(r) {
                        ...
                        var l = e.state.overlays[r]
                          ...
                          , u = 0;
                        n.state = !0,
                        bt(e, t.text, l.mode, n, (function(e, t) {
                            for (var n = s; u < e; ) {
                                var r = i[s];
                ...
                function ft(e, t, n) {
                    ...
                    var o = function(e, t, n) {
                        for (var r, i, o = e.doc, a = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), l = t; l > a; --l) {
                            ...
                            var s = Ge(o, l - 1)
                              , u = s.stateAfter;
                            if (u && (!n || l + (u instanceof ut ? u.lookAhead : 0) <= o.modeFrontier))
                                return l;
                ...
                function xt(e, t, n, r) {
                    var i, o, a = e.doc, l = a.mode, s = Ge(a, (t = lt(a, t)).line), u = ft(e, t.line, n), c = new $e(s.text,e.options.tabSize,u);
                ...
                function bt(e, t, n, r, i, o, a) {
                    ...
                    var s, u = 0, c = null, d = new $e(t,e.options.tabSize,r), h = e.options.addModeClass && [null];
                    for ("" == t && yt(mt(n, r.state), o); !d.eol(); ) {
                        if (d.pos > e.options.maxHighlightLength ? (l = !1,
                        a && pt(e, t, r, d.pos),
                        d.pos = t.length,
                        s = null) : s = yt(gt(n, d, r.state, h), o),
                        h) {
                            var f = h[0].name;
                            f && (s = "m-" + (s ? f + " " + s : f))
                        }
                    ...
                    if (!u) {
                        ...
                        if (x > 0 && l)
                            for (var y = 0; y < l.length; ++y)
                                null == l[y].to && (v || (v = [])).push(new Ct(l[y].marker,null,null));
                        for (var b = 0; b < x; ++b)
                            g.push(v);
                        g.push(s)
                    }
                        ...
                        for (var l = 0; l < a.length; ++l) {
                            ...
                            if (s.marker.collapsed) {
                                var u = s.marker.find(0)
                                  , c = tt(u.from, n) || Dt(s.marker) - Dt(i)
                                  , d = tt(u.to, r) || Ft(s.marker) - Ft(i);
                                if (!(c >= 0 && d <= 0 || c <= 0 && d >= 0) && (c <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? tt(u.to, n) >= 0 : tt(u.to, n) > 0) || c >= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? tt(u.from, r) <= 0 : tt(u.from, r) < 0)))
                                    return !0
                            }
                        }
                }
                    ...
                    if (n)
                        for (var r = void 0, i = 0; i < n.length; ++i)
                            if ((r = n[i]).marker.collapsed) {
                                if (null == r.from)
                                    return !0;
                                if (!r.marker.widgetNode && 0 == r.from && r.marker.inclusiveLeft && jt(e, t, r))
                                    return !0
                            }
                }
                function jt(e, t, n) {
                    ...
                    for (var i = void 0, o = 0; o < t.markedSpans.length; ++o)
                        if ((i = t.markedSpans[o]).marker.collapsed && !i.marker.widgetNode && i.from == n.to && (null == i.to || i.to != n.from) && (i.marker.inclusiveLeft || n.marker.inclusiveRight) && jt(e, t, i))
                            return !0
                }
                function qt(e) {
                ...
                function Yt(e, t) {
                    ...
                    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                        ...
                        o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = I(o.styleClasses.bgClass, r.bgClass || "")),
                        o.styleClasses.textClass && (r.textClass = I(o.styleClasses.textClass, r.textClass || ""))),
                        0 == r.map.length && r.map.push(0, 0, r.content.appendChild(Ne(e.display.measure))),
                    ...
                    return pe(e, "renderLine", e, t.line, r.pre),
                        ...
                        if (d.test(t)) {
                            ...
                            for (var f = 0; ; ) {
                                ...
                                if (m) {
                                    ...
                                    a && l < 9 ? u.appendChild(A("span", [g])) : u.appendChild(g),
                                ...
                                if ("\t" == p[0]) {
                                    var x = e.cm.options.tabSize
                                      , y = x - e.col % x;
                                    (v = u.appendChild(A("span", V(y), "cm-tab"))).setAttribute("role", "presentation"),
                                    v.setAttribute("cm-text", "\t"),
                                    e.col += y
                                } else
                                    "\r" == p[0] || "\n" == p[0] ? ((v = u.appendChild(A("span", "\r" == p[0] ? "␍" : "␤", "cm-invalidchar"))).setAttribute("cm-text", p[0]),
                                    e.col += 1) : ((v = e.cm.options.specialCharPlaceholder(p[0])).setAttribute("cm-text", p[0]),
                                    a && l < 9 ? u.appendChild(A("span", [v])) : u.appendChild(v),
                                    e.col += 1);
                ...
                function nn(e, t, n) {
                    var r = e.markedSpans
                      ...
                      , o = 0;
                    if (r)
                        for (var a, l, s, u, c, d, h, f = i.length, p = 0, m = 1, g = "", v = 0; ; ) {
                            if (v == p) {
                                s = u = c = l = "",
                                h = null,
                                d = null,
                                ...
                                for (var x = [], y = void 0, b = 0; b < r.length; ++b) {
                                    ...
                                    if ("bookmark" == k.type && w.from == p && k.widgetNode)
                                        ...
                                        k.css && (l = (l ? l + ";" : "") + k.css),
                                        k.startStyle && w.from == p && (c += " " + k.startStyle),
                                ...
                                if (y)
                                    for (var S = 0; S < y.length; S += 2)
                                        y[S + 1] == v && (u += " " + y[S]);
                                if (!d || d.from == p)
                                    for (var L = 0; L < x.length; ++L)
                                        tn(t, 0, x[L]);
                                if (d && (d.from || 0) == p) {
                                    if (tn(t, (null == d.to ? f + 1 : d.to) - p, d.marker, null == d.from),
                                    null == d.to)
                                        return;
                                    d.to == p && (d = !1)
                                }
                            ...
                            for (var T = Math.min(f, v); ; ) {
                                if (g) {
                                    var M = p + g.length;
                                    if (!d) {
                                        var N = M > T ? g.slice(0, T - p) : g;
                                        t.addToken(t, N, a ? a + s : s, c, p + N.length == v ? u : "", l, h)
                                    }
                                    if (M >= T) {
                                        g = g.slice(T - p),
                                        p = T;
                        ...
                        for (var A = 1; A < n.length; A += 2)
                            t.addToken(t, i.slice(o, o = n[A]), Zt(n[A + 1], t.cm.options))
                }
                function rn(e, t, n) {
                    this.line = t,
                ...
                function sn(e, t) {
                    ...
                    if (n.length) {
                        ...
                        an ? r = an.delayedCallbacks : ln ? r = ln : (r = ln = [],
                        setTimeout(un, 0));
                ...
                function mn(e, t, n, r) {
                    ...
                    if (e.options.lineNumbers || o) {
                        var a = dn(t)
                          , l = t.gutter = A("div", null, "CodeMirror-gutter-wrapper", "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px");
                        if (e.display.input.setUneditable(l),
                        a.insertBefore(l, t.text),
                        t.line.gutterClass && (l.className += " " + t.line.gutterClass),
                        !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(A("div", Je(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                        o)
                            for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
                                var u = e.display.gutterSpecs[s].className
                                  , c = o.hasOwnProperty(u) && o[u];
                                c && l.appendChild(A("div", [c], "CodeMirror-gutter-elt", "left: " + r.gutterLeft[u] + "px; width: " + r.gutterWidth[u] + "px"))
                            }
                    }
                }
                function gn(e, t, n) {
                ...
                function En(e, t) {
                    var n = Ze(t)
                      , r = Fn(e, n);
                    r && !r.text ? r = null : r && r.changes && (cn(e, r, n, or(e)),
                ...
                function On(e, t, n, r, i) {
                    ...
                    t.hasHeights = !0),
                    (o = function(e, t, n, r) {
                        var i, o = Hn(t.map, n, r), s = o.node, u = o.start, c = o.end, d = o.collapse;
                        if (3 == s.nodeType) {
                            for (var h = 0; h < 4; h++) {
                                ...
                                for (; o.coverStart + c < o.coverEnd && re(t.line.text.charAt(o.coverStart + c)); )
                                    ++c;
                                if ((i = a && l < 9 && 0 == u && c == o.coverEnd - o.coverStart ? s.parentNode.getBoundingClientRect() : Pn(L(s, u, c).getClientRects(), r)).left || i.right || 0 == u)
                                    break;
                                c = u,
                                u -= 1,
                                d = "right"
                            ...
                            var f;
                            u > 0 && (d = r = "right"),
                            i = e.options.lineWrapping && (f = s.getClientRects()).length > 1 ? f["right" == r ? f.length - 1 : 0] : s.getBoundingClientRect()
                        }
                        ...
                        e.options.singleCursorHeightPerLine || (k.rtop = m,
                        k.rbottom = g);
                        return k
                ...
                function Hn(e, t, n) {
                    for (var r, i, o, a, l, s, u = 0; u < e.length; u += 3)
                        ...
                        t < l ? (i = 0,
                        o = 1,
                        a = "left") : t < s ? o = (i = t - l) + 1 : (u == e.length - 3 || t == s && e[u + 3] > t) && (i = (o = s - l) - 1,
                        t >= s && (a = "right")),
                        null != i) {
                            if (r = e[u + 2],
                ...
                function Un(e, t, n, r, i) {
                    ...
                    r || (r = "local");
                    var a = qt(t);
                    if ("local" == r ? a += Cn(e.display) : a -= e.display.viewOffset,
                    "page" == r || "window" == r) {
                ...
                function Gn(e, t, n, r, i) {
                    return r || (r = Ge(e.doc, t.line)),
                    Un(e, r, Dn(e, r, t.ch, i), n)
                }
                function Vn(e, t, n, r, i, o) {
                    ...
                    var l = ue(r, e.doc.direction)
                      , s = t.ch
                      , u = t.sticky;
                    if (s >= r.text.length ? (s = r.text.length,
                    u = "before") : s <= 0 && (s = 0,
                    u = "after"),
                    !l)
                ...
                function Zn(e, t, n) {
                    ...
                    var i = Ye(r, n)
                      , o = r.first + r.size - 1;
                    if (i > o)
                        return Xn(r.first + r.size - 1, Ge(r, o).text.length, null, 1, 1);
                    t < 0 && (t = 0);
                    for (var a = Ge(r, i); ; ) {
                        var l = er(e, a, i, t, n)
                ...
                function Qn(e, t, n, r) {
                    return n || (n = En(e, t)),
                    Yn(e, t, n, Un(e, t, On(e, n, r), "line").top)
                }
                function Jn(e, t, n, r) {
                ...
                function er(e, t, n, r, i) {
                    ...
                    var h, f, p = null, m = null, g = oe((function(t) {
                        var n = On(e, o, t);
                        return n.top += a,
                        n.bottom += a,
                        !!Jn(n, r, i, !1) && (n.top <= i && n.left <= r && (p = t,
                        m = n),
                        !0)
                    }
                    ), l, s), v = !1;
                    if (m) {
                        ...
                        u || g != s && g != l || g++,
                        f = 0 == g ? "after" : g == t.text.length ? "before" : On(e, o, g - (u ? 1 : 0)).bottom + a <= i == u ? "after" : "before";
                        var b = Vn(e, et(n, g, f), "line", t, o);
                        h = b.left,
                        v = i < b.top ? -1 : i >= b.bottom ? 1 : 0
                    }
                ...
                function nr(e, t, n, r, i, o, a) {
                    ...
                    for (var c = null, d = null, h = 0; h < i.length; h++) {
                        var f = i[h];
                        if (!(f.from >= u || f.to <= s)) {
                            var p = On(e, r, 1 != f.level ? Math.min(u, f.to) - 1 : Math.max(s, f.from)).right
                              , m = p < o ? o - p + 1e9 : p - o;
                            (!c || d > m) && (c = f,
                            d = m)
                        }
                ...
                function ur(e, t, n, r) {
                    ...
                    if (r && u.xRel > 0 && (s = Ge(e.doc, u.line).text).length == u.ch) {
                        ...
                        u = et(u.line, Math.max(0, Math.round((o - Ln(e.display).left) / ir(e.display)) - c))
                    }
                    return u
                }
                function cr(e, t) {
                ...
                function dr(e, t, n, r) {
                    ...
                    t >= i.viewTo)
                        kt && Wt(e.doc, t) < i.viewTo && fr(e);
                    else if (n <= i.viewFrom)
                        kt && _t(e.doc, n + r) > i.viewFrom ? fr(e) : (i.viewFrom += r,
                        i.viewTo += r);
                        ...
                        i.viewTo = a.lineN) : fr(e)
                    } else {
                        var l = pr(e, t, t, -1)
                          , s = pr(e, n, n + r, 1);
                        l && s ? (i.view = i.view.slice(0, l.index).concat(on(e, l.lineN, s.lineN)).concat(i.view.slice(s.index)),
                        i.viewTo += r) : fr(e)
                    }
                    ...
                    for (var n = e.doc, r = {}, i = r.cursors = document.createDocumentFragment(), o = r.selection = document.createDocumentFragment(), a = 0; a < n.sel.ranges.length; a++)
                        if (t || a != n.sel.primIndex) {
                            ...
                            if (!(l.from().line >= e.display.viewTo || l.to().line < e.display.viewFrom)) {
                                var s = l.empty();
                                (s || e.options.showCursorWhenSelecting) && xr(e, l.head, i),
                                s || br(e, l, o)
                            }
                        }
                    return r
                ...
                function br(e, t, n) {
                    ...
                    function d(t, n, r) {
                        var o, a, d = Ge(i, t), h = d.text.length;
                        function f(n, r) {
                ...
                function Sr(e, t) {
                    e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1),
                    "nocursor" != e.options.readOnly && (e.state.focused || (pe(e, "focus", e, t),
                    e.state.focused = !0,
                ...
                function Lr(e, t) {
                    e.state.delayingBlurEvent || (e.state.focused && (pe(e, "blur", e, t),
                    e.state.focused = !1,
                    ...
                    for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
                        ...
                        if (!i.hidden) {
                            if (a && l < 8) {
                                ...
                                s = d.bottom - d.top,
                                !o && i.text.firstChild && (u = i.text.firstChild.getBoundingClientRect().right - d.left - 1)
                            }
                            var h = i.line.height - s;
                            if ((h > .005 || h < -.005) && (Xe(i.line, s),
                            Mr(i.line),
                            i.rest))
                                for (var f = 0; f < i.rest.length; f++)
                                    Mr(i.rest[f]);
                            if (u > e.display.sizerWidth) {
                                var p = Math.ceil(u / ir(e.display));
                                p > e.display.maxLineLength && (e.display.maxLineLength = p,
                ...
                function Nr(e, t, n) {
                    ...
                    if (n && n.ensure) {
                        var l = n.ensure.from.line
                          , s = n.ensure.to.line;
                        l < o ? (o = l,
                        a = Ye(t, qt(Ge(t, l)) + e.wrapper.clientHeight)) : Math.min(s, t.lastLine()) >= a && (o = Ye(t, qt(Ge(t, s)) - e.wrapper.clientHeight),
                        a = s)
                    }
                    return {
                        from: o,
                ...
                function Or(e) {
                    ...
                    Ir(e, Kn(e, t.from), Kn(e, t.to), t.margin))
                }
                function Ir(e, t, n, r) {
                    var i = Ar(e, {
                ...
                function Ur(e) {
                    ...
                    e.display.scrollbars = new qr[e.options.scrollbarStyle]((function(t) {
                ...
                function Kr(e) {
                    ...
                    e.update = e.mustUpdate && new oi(t,e.mustUpdate && {
                        top: e.scrollTop,
                ...
                function Zr(e) {
                    ...
                    e.barMeasure = Rr(t),
                    n.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = Dn(t, n.maxLine, n.maxLine.text.length).left + 3,
                    t.display.sizerWidth = e.adjustWidthTo,
                    e.barMeasure.scrollWidth = Math.max(n.scroller.clientWidth, n.sizer.offsetLeft + e.adjustWidthTo + Tn(t) + t.display.barWidth),
                    e.maxScrollLeft = Math.max(0, n.sizer.offsetLeft + e.adjustWidthTo - Mn(t))),
                ...
                function Yr(e) {
                    ...
                    e.maxScrollLeft < t.doc.scrollLeft && Pr(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
                    t.display.maxLineChanged = !1);
                    var n = e.focus && e.focus == E();
                    e.preparedSelection && t.display.input.showSelection(e.preparedSelection, n),
                    (e.updatedDisplay || e.startHeight != t.doc.height) && Br(t, e.barMeasure),
                    ...
                    e.scrollToPos) && function(e, t) {
                        ...
                        for (var o = 0; o < 5; o++) {
                            var a = !1
                              ...
                              , c = e.doc.scrollTop
                              , d = e.doc.scrollLeft;
                            if (null != u.scrollTop && (zr(e, u.scrollTop),
                            Math.abs(e.doc.scrollTop - c) > 1 && (a = !0)),
                            null != u.scrollLeft && (Pr(e, u.scrollLeft),
                    ...
                    if (!(t.highlightFrontier >= e.display.viewTo)) {
                        ...
                        t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), (function(o) {
                            if (r.line >= e.display.viewFrom) {
                                ...
                                o.text.length <= e.options.maxHighlightLength && pt(e, o.text, r),
                                o.stateAfter = r.line % 5 == 0 ? r.save() : null,
                                r.nextLine();
                            if (+new Date > n)
                                return ri(e, e.options.workDelay),
                                !0
                        }
                        )),
                        t.highlightFrontier = r.line,
                        t.modeFrontier = Math.max(t.modeFrontier, r.line),
                        i.length && Jr(e, (function() {
                ...
                function ai(e, t) {
                    ...
                    if (t.editorIsHidden)
                        return fr(e),
                        !1;
                    if (!t.force && t.visible.from >= n.viewFrom && t.visible.to <= n.viewTo && (null == n.updateLineNumbers || n.updateLineNumbers >= n.viewTo) && n.renderedView == n.view && 0 == mr(e))
                        return !1;
                    hi(e) && (fr(e),
                    t.dims = or(e));
                    ...
                    !function(e, t, n) {
                        var r = e.display;
                        0 == r.view.length || t >= r.viewTo || n <= r.viewFrom ? (r.view = on(e, t, n),
                        r.viewFrom = t) : (r.viewFrom > t ? r.view = on(e, t, r.viewFrom).concat(r.view) : r.viewFrom < t && (r.view = r.view.slice(cr(e, t))),
                        r.viewFrom = t,
                    ...
                    function(e, t, n) {
                        ...
                        function l(t) {
                            var n = t.nextSibling;
                            return s && x && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t),
                            n
                        }
                        for (var u = r.view, c = r.viewFrom, d = 0; d < u.length; d++) {
                            ...
                            if (h.hidden)
                                ...
                                h.changes && (_(h.changes, "gutter") > -1 && (f = !1),
                                cn(e, h, c, n)),
                                f && (M(h.lineNumber),
                                h.lineNumber.appendChild(document.createTextNode(Je(e.options, c)))),
                    ...
                    function(e) {
                        if (e && e.activeElt && e.activeElt != E() && (e.activeElt.focus(),
                        e.anchorNode && F(document.body, e.anchorNode) && F(document.body, e.focusNode))) {
                ...
                function li(e, t) {
                    for (var n = t.viewport, r = !0; ; r = !1) {
                        if (r && e.options.lineWrapping && t.oldDisplayWidth != Mn(e))
                            ...
                            top: Math.min(e.doc.height + Sn(e.display) - Nn(e), n.top)
                        }),
                ...
                function gi(e, t, r, i) {
                    ...
                    o.sizerWidth = null,
                    o.heightForcer = A("div", null, null, "position: absolute; height: 30px; width: 1px;"),
                ...
                function wi(e, t) {
                    ...
                    if (i && u || o && c) {
                        if (o && x && s)
                            e: for (var h = t.target, f = a.view; h != l; h = h.parentNode)
                        ...
                        if (i && !n && !d && null != xi)
                            return o && c && zr(e, Math.max(0, l.scrollTop + o * xi)),
                            Pr(e, Math.max(0, l.scrollLeft + i * xi)),
                            (!o || o && c) && ye(t),
                        ...
                        vi < 20 && (null == a.wheelStartX ? (a.wheelStartX = l.scrollLeft,
                ...
                ki.prototype.equals = function(e) {
                    ...
                    for (var t = 0; t < this.ranges.length; t++) {
                        var n = this.ranges[t]
                          , r = e.ranges[t];
                        if (!nt(n.anchor, r.anchor) || !nt(n.head, r.head))
                            return !1
                    }
                    return !0
                }
                ...
                ki.prototype.deepCopy = function() {
                    for (var e = [], t = 0; t < this.ranges.length; t++)
                        e[t] = new Ci(rt(this.ranges[t].anchor),rt(this.ranges[t].head));
                ...
                function Si(e, t, n) {
                    ...
                    for (var o = 1; o < t.length; o++) {
                        ...
                        if (r && !a.empty() ? s > 0 : s >= 0) {
                            ...
                            o <= n && --n,
                            t.splice(--o, 2, new Ci(d ? c : u,d ? u : c))
                        }
                    }
                    return new ki(t,n)
                }
                ...
                function Mi(e, t) {
                    ...
                    var n = e.line + t.text.length - (t.to.line - t.from.line) - 1
                      , r = e.ch;
                    return e.line == t.to.line && (r += Ti(t).ch - t.to.ch),
                    et(n, r)
                }
                function Ni(e, t) {
                ...
                function Di(e) {
                    e.doc.mode = We(e.options, e.doc.modeOption),
                    Fi(e)
                }
                function Fi(e) {
                ...
                function _i(e, t, n, r) {
                    ...
                    if ((i.lastOp == r || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > l - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = function(e, t) {
                        return t ? (Wi(e.done),
                        K(e.done)) : e.done.length && !K(e.done).ranges ? K(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(),
                        K(e.done)) : void 0
                    }(i, i.lastOp == r)))
                        a = K(o.changes),
                        0 == tt(t.from, t.to) && 0 == tt(t.from, a.to) ? a.to = Ti(t) : o.changes.push(Ri(e, t));
                    else {
                        var s = K(i.done);
                        for (s && s.ranges || ji(e.sel, i.done),
                        o = {
                            changes: [Ri(e, t)],
                ...
                function Bi(e, t, n, r) {
                    ...
                    }(e, o, K(i.done), t)) ? i.done[i.done.length - 1] = t : ji(t, i.done),
                ...
                function Gi(e, t, n) {
                    for (var r = [], i = 0; i < e.length; ++i) {
                        var o = e[i];
                        if (o.ranges)
                            r.push(n ? ki.prototype.deepCopy.call(o) : o);
                        else {
                            var a = o.changes
                              , l = [];
                            r.push({
                            ...
                            for (var s = 0; s < a.length; ++s) {
                                ...
                                t)
                                    for (var d in u)
                                        (c = d.match(/^spans_(\d+)$/)) && _(t, Number(c[1])) > -1 && (K(l)[d] = u[d],
                                        delete u[d])
                            }
                        }
                    }
                ...
                function Ki(e, t, n, r, i) {
                    ...
                    Ji(e, new ki([Vi(e.sel.primary(), t, n, i)],0), r)
                }
                function Xi(e, t, n) {
                ...
                function Zi(e, t, n, r) {
                    ...
                    i[t] = n,
                    Ji(e, Si(e.cm, i, e.sel.primIndex), r)
                }
                function Yi(e, t, n, r) {
                    Ji(e, Li(t, n), r)
                }
                ...
                function Ji(e, t, n) {
                    eo(e, t, n),
                    Bi(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n)
                }
                function eo(e, t, n) {
                    (ve(e, "beforeSelectionChange") || e.cm && ve(e.cm, "beforeSelectionChange")) && (t = function(e, t, n) {
                        ...
                        return pe(e, "beforeSelectionChange", e, r),
                ...
                function ro(e, t, n, r) {
                    for (var i, o = 0; o < t.ranges.length; o++) {
                        ...
                        (i || s != a.anchor || u != a.head) && (i || (i = t.ranges.slice(0, o)),
                        i[o] = new Ci(s,u))
                    }
                            ...
                            if ((null == l.from || (u ? l.from <= t.ch : l.from < t.ch)) && (null == l.to || (c ? l.to >= t.ch : l.to > t.ch))) {
                                ...
                                if (n) {
                                    var d = s.find(r < 0 ? 1 : -1)
                                      , h = void 0;
                                    if ((r < 0 ? c : u) && (d = ao(e, d, -r, d && d.line == t.line ? o : null)),
                                    d && d.line == t.line && (h = tt(d, n)) && (r < 0 ? h < 0 : h > 0))
                                        return io(e, d, t, r, i)
                                }
                                var f = s.find(r < 0 ? -1 : 1);
                                return (r < 0 ? u : c) && (f = ao(e, f, r, f.line == t.line ? o : null)),
                                f ? io(e, f, t, r, i) : null
                            }
                        }
                    return t
                ...
                function co(e, t) {
                    if (1 != t.text.length || "" != t.text[0] || 0 != tt(t.from, t.to)) {
                        var n = Ni(e, t);
                        _i(e, t, n, e.cm ? e.cm.curOp.id : NaN),
                        po(e, t, n, Tt(e, t));
                        var r = [];
                        Ii(e, (function(e, n) {
                            n || -1 != _(r, e.history) || (xo(e.history, t),
                            r.push(e.history)),
                            po(e, t, null, Tt(e, t))
                        }
                        ))
                ...
                function ho(e, t, n) {
                    ...
                    if (!r || n) {
                        for (var i, o = e.history, a = e.sel, l = "undo" == t ? o.done : o.undone, s = "undo" == t ? o.undone : o.done, u = 0; u < l.length && (i = l[u],
                        n ? !i.ranges || i.equals(e.sel) : i.ranges); u++)
                            ;
                        if (u != l.length) {
                            ...
                            for (var d = ve(e, "beforeChange") || e.cm && ve(e.cm, "beforeChange"), h = function(n) {
                                ...
                                var a = [];
                                Ii(e, (function(e, t) {
                                    t || -1 != _(a, e.history) || (xo(e.history, r),
                                    a.push(e.history)),
                                    po(e, r, null, $i(e, r))
                                }
                                ))
                ...
                function fo(e, t) {
                    if (0 != t && (e.first += t,
                    e.sel = new ki(X(e.sel.ranges, (function(e) {
                    ...
                    if (t.to.line < e.first)
                        ...
                        e.cm ? function(e, t, n) {
                            var r = e.doc
                              ...
                              , l = !1
                              , s = o.line;
                            e.options.lineWrapping || (s = Ze(Rt(Ge(r, o.line))),
                            ...
                            t.full ? dr(e) : o.line != a.line || 1 != t.text.length || Ei(e.doc, t) ? dr(e, o.line, a.line + 1, u) : hr(e, o.line, "text");
                            var c = ve(e, "changes")
                              , d = ve(e, "change");
                            if (d || c) {
                                var h = {
                ...
                function yo(e, t, n, r) {
                    var i = t
                      , o = t;
                    return "number" == typeof t ? o = Ge(e, at(e, t)) : i = Ze(t),
                    null == i ? null : (r(o, i) && e.cm && hr(e.cm, i, n),
                    o)
                }
                function bo(e) {
                    this.lines = e,
                ...
                ko.prototype.changed = function() {
                    ...
                    this.height = null;
                    var i = wn(this) - t;
                    i && (Bt(this.doc, r) || Xe(r, r.height + i),
                    n && Jr(n, (function() {
                ...
                function To(e, t, n, r, i) {
                    ...
                    o.collapsed) {
                        if (Pt(e, t.line, t, n, o) || t.line != n.line && Pt(e, n.line, t, n, o))
                    ...
                    if (e.iter(s, n.line + 1, (function(e) {
                        u && o.collapsed && !u.options.lineWrapping && Rt(e) == u.display.maxLine && (l = !0),
                        o.collapsed && s != t.line && Xe(e, 0),
                        function(e, t) {
                            e.markedSpans = e.markedSpans ? e.markedSpans.concat([t]) : [t],
                            t.marker.attachLine(e)
                        }(e, new Ct(o,s == t.line ? t.ch : null,s == n.line ? n.ch : null)),
                        ++s
                    }
                    )),
                ...
                Lo.prototype.clear = function() {
                    if (!this.explicitlyCleared) {
                        ...
                        for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                            ...
                            e && !this.collapsed ? hr(e, Ze(a), "text") : e && (null != l.to && (i = Ze(a)),
                            null != l.from && (r = Ze(a))),
                            a.markedSpans = Lt(a.markedSpans, l),
                            null == l.from && this.collapsed && !Bt(this.doc, a) && e && Xe(a, rr(e.display))
                        }
                ...
                Lo.prototype.find = function(e, t) {
                    ...
                    for (var i = 0; i < this.lines.length; ++i) {
                        ...
                        if (null != a.from && (n = et(t ? o : Ze(o), a.from),
                        -1 == e))
                            return n;
                        if (null != a.to && (r = et(t ? o : Ze(o), a.to),
                        1 == e))
                            return r
                    }
                    return n && {
                ...
                var Do = 0
                  , Fo = function(e, t, n, r, i) {
                    ...
                    null == n && (n = 0),
                    wo.call(this, [new bo([new Gt("",null)])]),
                    this.first = n,
                ...
                Fo.prototype = Y(wo.prototype, {
                    ...
                    getLineHandleVisualStart: function(e) {
                        return "number" == typeof e && (e = Ge(this, e)),
                        Rt(e)
                    },
                    lineCount: function() {
                        return this.size
                    ...
                    addSelection: ni((function(e, t, n) {
                        ...
                        Ji(this, Si(this.cm, r, r.length - 1), n)
                    }
                    )),
                    ...
                    addLineWidget: ni((function(e, t, n) {
                        return function(e, t, n, r) {
                            ...
                            o && sn(o, "lineWidgetAdded", o, i, "number" == typeof t ? t : Ze(t)),
                            i
                        }(this, e, t, n)
                    }
                    )),
                            ...
                            if (r && r.length && window.FileReader && window.File)
                                for (var i = r.length, o = Array(i), l = 0, s = function() {
                                    ++l == i && ei(t, (function() {
                                        ...
                                        uo(t.doc, e),
                                        Qi(t.doc, Li(lt(t.doc, n), lt(t.doc, Ti(e))))
                                    }
                                    ))()
                                }, u = function(e, n) {
                ...
                for (var Wo = {
                    ...
                    Wo[_o + 48] = Wo[_o + 96] = String(_o);
                for (var Bo = 65; Bo <= 90; Bo++)
                    Wo[Bo] = String.fromCharCode(Bo);
                for (var jo = 1; jo <= 12; jo++)
                    Wo[jo + 111] = Wo[jo + 63235] = "F" + jo;
                var qo = {};
                function Uo(e) {
                        ...
                        return Jr(e, (function() {
                            for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
                                if (t[r].empty()) {
                                    ...
                                    if (o)
                                        if (i.ch == o.length && (i = new et(i.line,i.ch - 1)),
                                        i.ch > 0)
                                            ...
                                            a && (i = new et(i.line,1),
                                            e.replaceRange(o.charAt(0) + e.doc.lineSeparator() + a.charAt(a.length - 1), et(i.line - 1, a.length - 1), i, "+transpose"))
                                        }
                                    n.push(new Ci(i,i))
                                }
                            e.setSelections(n)
                ...
                function ca(e) {
                    ...
                    !me(t, e)) {
                        ...
                        var i = sa(t, e);
                        d && (ua = i ? r : null,
                        i || 88 != r || Oe || !(x ? e.metaKey : e.ctrlKey) || t.replaceSelection("", null, "cut")),
                        n && !x && !i && 46 == r && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
                ...
                function ha(e) {
                    var t = this;
                    if (!(kn(t.display, e) || me(t, e) || e.ctrlKey && !e.altKey || x && e.metaKey)) {
                        var n = e.keyCode
                          , r = e.charCode;
                        if (d && n == ua)
                            return ua = null,
                    ...
                    if (!(me(t, e) || n.activeTouch && n.input.supportsTouch()))
                        ...
                        kn(n, e))
                            ...
                            var r = ur(t, e)
                              ...
                              , o = r ? function(e, t) {
                                var n = +new Date;
                                return pa && pa.compare(n, e, t) ? (fa = pa = null,
                                "triple") : fa && fa.compare(n, e, t) ? (pa = new ma(n,e,t),
                                fa = null,
                                "double") : (fa = new ma(n,e,t),
                                pa = null,
                                "single")
                            }(r, i) : "single";
                            window.focus(),
                            ...
                            r && function(e, t, n, r, i) {
                                ...
                                e.options.dragDrop && Me && !e.isReadOnly() && "single" == n && (i = u.contains(t)) > -1 && (tt((i = u.ranges[i]).from(), t) < 0 || t.xRel > 0) && (tt(i.to(), t) > 0 || t.xRel < 0) ? function(e, t, n, r) {
                                    var i = e.display
                                      , o = !1
                                      , u = ei(e, (function(t) {
                                    ...
                                    r.addNew && !r.extend ? (l = o.sel.contains(n),
                                    a = l > -1 ? u[l] : new Ci(n,n)) : (a = o.sel.primary(),
                                    l = o.sel.primIndex);
                                    if ("rectangle" == r.unit)
                                        r.addNew || (a = new Ci(n,n)),
                                        n = ur(e, t, !0, !0),
                                        l = -1;
                                    else {
                                        var c = va(e, n, r.unit);
                                    ...
                                    Ji(o, Si(e, u.concat([a]), l), {
                                        scroll: !1,
                                        origin: "*mouse"
                                    })) : u.length > 1 && u[l].empty() && "char" == r.unit && !r.extend ? (Ji(o, Si(e, u.slice(0, l).concat(u.slice(l + 1)), 0), {
                                        scroll: !1,
                                        origin: "*mouse"
                                    }),
                                    s = o.sel) : Zi(o, l, a, q) : (l = 0,
                                    Ji(o, new ki([a],0), q),
                                    s = o.sel);
                                    var d = n;
                                    function h(t) {
                                        if (0 != tt(d, t))
                                            if (d = t,
                                            "rectangle" == r.unit) {
                                                for (var i = [], u = e.options.tabSize, c = R(Ge(o, n.line).text, n.ch, u), h = R(Ge(o, t.line).text, t.ch, u), f = Math.min(c, h), p = Math.max(c, h), m = Math.min(n.line, t.line), g = Math.min(e.lastLine(), Math.max(n.line, t.line)); m <= g; m++) {
                                                    var v = Ge(o, m).text
                                                      , x = $(v, f, u);
                                                    f == p ? i.push(new Ci(et(m, x),et(m, x))) : v.length > x && i.push(new Ci(et(m, x),et(m, $(v, p, u))))
                                                }
                                                i.length || i.push(new Ci(n,n)),
                                                Ji(o, Si(e, s.ranges.slice(0, l).concat(i), l), {
                                                    origin: "*mouse",
                                                    scroll: !1
                                                }),
                                                e.scrollIntoView(t)
                                            } else {
                                                var y, b = a, w = va(e, t, r.unit), k = b.anchor;
                                                tt(w.anchor, k) > 0 ? (y = w.head,
                                                k = ot(b.from(), w.anchor)) : (y = w.anchor,
                                                k = it(b.to(), w.head));
                            ...
                            }(t, r, o, e) : Ce(e) == n.scroller && ye(e) : 2 == i ? (r && Ki(t.doc, r),
                            setTimeout((function() {
                ...
                function Ma(e, t) {
                    ...
                    P(Ca, t, !1);
                    var r = t.value;
                    "string" == typeof r ? r = new Fo(r,t.mode,null,t.lineSeparator,t.direction) : t.mode && (r.modeOption = t.mode),
                    this.doc = r;
                    ...
                    function(e) {
                        ...
                        de(t.scroller, "dblclick", a && l < 11 ? ei(e, (function(t) {
                            if (!me(e, t)) {
                                var n = ur(e, t);
                        ...
                        de(t.scroller, "touchend", (function(n) {
                            ...
                            if (r && !kn(t, n) && null != r.left && !r.moved && new Date - r.start < 300) {
                                ...
                                a = !r.prev || o(r, r.prev) ? new Ci(l,l) : !r.prev.prev || o(r, r.prev.prev) ? e.findWordAt(l) : new Ci(et(l.line, 0),lt(e.doc, et(l.line + 1, 0))),
                            ...
                            start: function(t) {
                                return function(e, t) {
                                    if (a && (!e.state.draggingText || +new Date - Eo < 100))
                                        ke(t);
                                    else if (!me(e, t) && !kn(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()),
                        ...
                        de(s, "keydown", ei(e, ca)),
                        de(s, "keypress", ei(e, ha)),
                    ...
                    zi(this, r),
                    t.autofocus && !v || this.hasFocus() ? setTimeout(H(Sr, this), 20) : Lr(this),
                    Sa)
                ...
                Ma.defaults = Ca,
                Ma.optionHandlers = Sa;
                var Na = [];
                function Aa(e, t, n, r) {
                    var i, o = e.doc;
                    null == n && (n = "add"),
                    "smart" == n && (o.mode.indent ? i = ft(e, t).state : n = "prev");
                    ...
                    if (r || /\S/.test(l.text)) {
                        if ("smart" == n && ((u = o.mode.indent(i, l.text.slice(c.length), l.text)) == B || u > 150)) {
                            if (!r)
                                return;
                            n = "prev"
                        }
                        ...
                        u = 0,
                        n = "not";
                    "prev" == n ? u = t > o.first ? R(Ge(o, t - 1).text, null, a) : 0 : "add" == n ? u = s + e.options.indentUnit : "subtract" == n ? u = s - e.options.indentUnit : "number" == typeof n && (u = s + n),
                    u = Math.max(0, u);
                    var d = ""
                      , h = 0;
                    ...
                    if (h < u && (d += V(u - h)),
                    d != c)
                        return mo(o, d, et(t, 0), et(t, c.length), "+input"),
                        l.stateAfter = null,
                        !0;
                    ...
                    if (l && r.ranges.length > 1)
                        if (Da && Da.text.join("\n") == t) {
                            if (r.ranges.length % Da.text.length == 0) {
                                u = [];
                                for (var c = 0; c < Da.text.length; c++)
                                    u.push(o.splitLines(Da.text[c]))
                            }
                        } else
                            s.length == r.ranges.length && e.options.pasteLinesPerSelection && (u = X(s, (function(e) {
                                return [e]
                            }
                            )));
                ...
                function Oa(e, t) {
                    ...
                    if (n)
                        ...
                        t.isReadOnly() || t.options.disableInput || Jr(t, (function() {
                        ...
                        for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                            ...
                            if (!(i.head.ch > 100 || r && n.ranges[r - 1].head.line == i.head.line)) {
                                ...
                                if (o.electricChars) {
                                    ...
                                    o.electricInput && o.electricInput.test(Ge(e.doc, i.head.line).text.slice(0, i.head.ch)) && (a = Aa(e, i.head.line, "smart"));
                ...
                function Ra(e, t, n, r, i) {
                    ...
                    function u(r) {
                        ...
                        if (null == (o = i ? function(e, t, n, r) {
                            ...
                            var l, s = function(e, n) {
                                ...
                                return e.options.lineWrapping ? (l = l || En(e, t),
                                Qn(e, t, l, n)) : {
                                    begin: 0,
                                    end: t.text.length
                                }
                            ...
                            if (r || (a = t.line + s) < e.first || a >= e.first + e.size || (t = new et(a,t.ch,t.sticky),
                            !(l = Ge(e, a))))
                                return !1;
                    ...
                    if ("char" == r)
                        ...
                        for (var c = null, d = "group" == r, h = e.cm && e.cm.getHelper(t, "wordChars"), f = !0; !(n < 0) || u(!f); f = !1) {
                ...
                function Ua(e, t, n) {
                    ...
                    n && (n = a.nodeValue.length)); l.parentNode != r; )
                        l = l.parentNode;
                    var s = e.measure
                      , u = s.maps;
                    function c(t, n, r) {
                ...
                _a.prototype.init = function(e) {
                    ...
                    Ha(i, r.options.spellcheck, r.options.autocorrect, r.options.autocapitalize),
                    de(i, "paste", (function(e) {
                        me(r, e) || Oa(e, r) || l <= 11 && setTimeout(ei(r, (function() {
                ...
                _a.prototype.prepareSelection = function() {
                    var e = vr(this.cm, !1);
                    return e.focus = document.activeElement == this.div,
                    e
                }
                ,
                    ...
                    if (t.display.viewTo == t.display.viewFrom || i.line >= t.display.viewTo || o.line < t.display.viewFrom)
                        ...
                        if (!a || a.bad || !l || l.bad || 0 != tt(ot(a, l), i) || 0 != tt(it(a, l), o)) {
                            var s = t.display.view
                              , u = i.line >= t.display.viewFrom && Ba(t, i) || {
                                node: s[0].measure.map[2],
                                offset: 0
                            }
                              , c = o.line < t.display.viewTo && Ba(t, o);
                            if (!c) {
                            ...
                            if (u && c) {
                                ...
                                try {
                                    f = L(u.node, u.offset, c.offset, c.node)
                                } catch (e) {}
                ...
                _a.prototype.pollContent = function() {
                    ...
                    if (0 == a.ch && a.line > r.firstLine() && (a = et(a.line - 1, Ge(r.doc, a.line - 1).length)),
                    l.ch == Ge(r.doc, l.line).text.length && l.line < r.lastLine() && (l = et(l.line + 1, 0)),
                    a.line < i.viewFrom || l.line > i.viewTo - 1)
                        return !1;
                    a.line == i.viewFrom || 0 == (e = cr(r, a.line)) ? (t = Ze(i.view[0].line),
                    n = i.view[0].node) : (t = Ze(i.view[e].line),
                    n = i.view[e - 1].node.nextSibling);
                    var s, u, c = cr(r, l.line);
                    if (c == i.view.length - 1 ? (s = i.viewTo - 1,
                    u = i.lineDiv.lastChild) : (s = Ze(i.view[c + 1].line) - 1,
                    ...
                    for (var d = r.doc.splitLines(function(e, t, n, r, i) {
                        ...
                        function d(t) {
                            if (1 == t.nodeType) {
                                ...
                                if (h) {
                                    var f = e.findMarks(et(r, 0), et(i + 1, 0), (g = +h,
                                    function(e) {
                                        return e.id == g
                                    }
                                    ));
                                    return void (f.length && (o = f[0].find(0)) && c(Ve(e.doc, o.from, o.to).join(l)))
                                }
                    ...
                    return d.length > 1 || d[0] || tt(w, k) ? (mo(r.doc, d, w, k, "+input"),
                    !0) : void 0
                }
                ,
                ...
                _a.prototype.onKeyPress = function(e) {
                    ...
                    this.cm.isReadOnly() || ei(this.cm, Ea)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
                }
                ,
                ...
                $a.prototype.init = function(e) {
                    ...
                    function o(e) {
                        if (!me(r, e)) {
                            if (r.somethingSelected())
                                ...
                                "cut" == e.type ? r.setSelections(t.ranges, null, j) : (n.prevInput = "",
                                i.value = t.text.join("\n"),
                                z(i))
                            }
                    ...
                    de(i, "paste", (function(e) {
                        me(r, e) || Oa(e, r) || (r.state.pasteIncoming = +new Date,
                        n.fastPoll())
                    }
                    )),
                    de(i, "cut", o),
                ...
                $a.prototype.poll = function() {
                    var e = this
                      ...
                      , n = this.textarea
                      , r = this.prevInput;
                    if (this.contextMenuPending || !t.state.focused || Ee(n) && !r && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
                        return !1;
                    var i = n.value;
                    if (i == r && !t.somethingSelected())
                        return !1;
                    if (a && l >= 9 && this.hasSelection === i || x && /[\uf700-\uf7ff]/.test(i))
                    ...
                    return Jr(t, (function() {
                        Ea(t, i.slice(s), r.length - s, null, e.composing ? "*compose" : null),
                ...
                $a.prototype.onContextMenu = function(e) {
                    ...
                    if (o && !d) {
                        ...
                        var c, h = i.style.cssText, f = t.wrapper.style.cssText, p = t.wrapper.offsetParent.getBoundingClientRect();
                    ...
                    function v() {
                        ...
                        null != i.selectionStart)) {
                            ...
                            var e = 0
                              , o = function() {
                                r.selForContextMenu == n.doc.sel && 0 == i.selectionStart && i.selectionEnd > 0 && "​" == t.prevInput ? ei(n, lo)(n) : e++ < 10 ? r.detectingSelectAll = setTimeout(o, 500) : (r.selForContextMenu = null,
                                r.input.reset())
                            };
                ...
                function(e) {
                    ...
                    n("lineNumbers", !1, (function(e, t) {
                        e.display.gutterSpecs = fi(e.options.gutters, t),
                        mi(e)
                    }
                    ), !0),
                    ...
                    e.prototype = {
                        ...
                        indentSelection: ti((function(e) {
                            for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                                var i = t[r];
                                if (i.empty())
                                    i.head.line > n && (Aa(this, i.head.line, e, !0),
                                    n = i.head.line,
                                    ...
                                    0 == o.ch && t.length == u.length && u[r].from().ch > 0 && Zi(this.doc, r, new Ci(o,u[r].to()), j)
                                }
                            }
                        }
                        )),
                        ...
                        getTokenTypeAt: function(e) {
                            e = lt(this.doc, e);
                            var t, n = ht(this, Ge(this.doc, e.line)), r = 0, i = (n.length - 1) / 2, o = e.ch;
                            if (0 == o)
                                t = n[2];
                            else
                                for (; ; ) {
                        ...
                        addWidget: function(e, t, n, r, i) {
                            var o, a, l, s = this.display, u = (e = Vn(this, lt(this.doc, e))).bottom, c = e.left;
                            ...
                            "over" == r)
                                ...
                                ("above" == r || e.bottom + t.offsetHeight > d) && e.top > t.offsetHeight ? u = e.top - t.offsetHeight : e.bottom + t.offsetHeight <= d && (u = e.bottom),
                            ...
                            null != (l = Ar(o, a)).scrollTop && zr(o, l.scrollTop),
                            null != l.scrollLeft && Pr(o, l.scrollLeft))
                        },
                        ...
                        moveV: ti((function(e, t) {
                            ...
                            if (r.extendSelectionsBy((function(a) {
                                ...
                                i.push(l.left);
                                var s = Wa(n, l, e, t);
                                return "page" == t && a == r.sel.primary() && Dr(n, Gn(n, s, "div").top - l.top),
                                s
                            }
                            ), U),
                            i.length)
                        ...
                        toggleOverwrite: function(e) {
                            null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? O(this.display.cursorDiv, "CodeMirror-overwrite") : T(this.display.cursorDiv, "CodeMirror-overwrite"),
                        ...
                        refresh: ti((function() {
                            ...
                            ui(this.display),
                            (null == e || Math.abs(e - rr(this.display)) > .5) && sr(this),
                            pe(this, "refresh", this)
                        }
                        )),
                ...
                for (var Va in Fo.prototype)
                    Fo.prototype.hasOwnProperty(Va) && _(Ga, Va) < 0 && (Ma.prototype[Va] = function(e) {
                        return function() {
                      ...
                      , o = {
                        ...
                        token: function(e, n) {
                            ...
                            if ("`" === e.peek()) {
                                ...
                                e.eatWhile("`");
                                var a = 1 + e.pos - o;
                                return n.code ? a === i && (n.code = !1) : (i = a,
                                n.code = !0),
                                null
                            }
                            if (n.code)
        ...
        11: [function(e, t, n) {
            ...
            r = function(e) {
                ...
                e.defineMode("markdown", (function(t, n) {
                    ...
                    function y(r, i) {
                        var a, h = r.column() === i.indentation, m = !(a = i.prevLine.stream) || !/\S/.test(a.string), v = i.indentedCode, x = i.prevLine.hr, y = !1 !== i.list, b = (i.listStack[i.listStack.length - 1] || 0) + 3;
                        i.indentedCode = !1;
                        var C = i.indentation;
                        if (null === i.indentationDiff && (i.indentationDiff = i.indentation,
                        y)) {
                        ...
                        if (r.eatSpace())
                            return null;
                        if (h && i.indentation <= b && (T = r.match(c)) && T[1].length <= 6)
                            return i.quote = 0,
                            i.header = T[1].length,
                            i.thisLine.header = !0,
                        ...
                        if (!L && !i.setext && h && i.indentation <= b && (T = r.match(s))) {
                            ...
                            i.f = i.inline,
                            n.highlightFormatting && (i.formatting = ["list", "list-" + M]),
                            k(i)
                        }
                        return h && i.indentation <= b && (T = r.match(f, !0)) ? (i.quote = 0,
                        i.fencedEndRE = new RegExp(T[1] + "+ *$"),
                        i.localMode = n.fencedCodeBlockHighlighting && function(n) {
                            if (e.findModeByName) {
                        ...
                        i.code = -1,
                        k(i)) : i.setext || !(S && y || i.quote || !1 !== i.list || i.code || L || p.test(r.string)) && (T = r.lookAhead(1)) && (T = T.match(d)) ? (i.setext ? (i.header = i.setext,
                        i.setext = 0,
                        r.skipToEnd(),
                        n.highlightFormatting && (i.formatting = "header")) : (i.header = "=" == T[0].charAt(0) ? 1 : 2,
                        i.setext = i.header),
                        i.thisLine.header = !0,
                        i.f = i.inline,
                        k(i)) : L ? (r.skipToEnd(),
                        i.hr = !0,
                        i.thisLine.hr = !0,
                        o.hr) : "[" === r.peek() ? g(r, i, N) : g(r, i, i.inline)
                    }
                    function b(t, n) {
                        var o = r.token(t, n.htmlState);
                        if (!i) {
                            var a = e.innerMode(r, n.htmlState);
                            ("xml" == a.mode.name && null === a.state.tagStart && !a.state.context && a.state.tokenize.isInText || n.md_inside && t.current().indexOf(">") > -1) && (n.f = S,
                            n.block = y,
                            n.htmlState = null)
                        }
                        return o
                    ...
                    function w(e, t) {
                        var r, i = t.listStack[t.listStack.length - 1] || 0, a = t.indentation < i, l = i + 3;
                        ...
                        a ? v(e, t, t.block) : r) : t.localMode ? t.localMode.token(e, t.localState) : (e.skipToEnd(),
                        o.code)
                    }
                    function k(e) {
                        var t = [];
                        if (e.formatting) {
                            ...
                            for (var r = 0; r < e.formatting.length; r++)
                                ...
                                "quote" === e.formatting[r] && (!n.maxBlockquoteDepth || n.maxBlockquoteDepth >= e.quote ? t.push(o.formatting + "-" + e.formatting[r] + "-" + e.quote) : t.push("error"))
                        }
                        if (e.taskOpen)
                            return t.push("meta"),
                    ...
                    function S(t, i) {
                        ...
                        if (i.list)
                            ...
                            k(i);
                        if (i.taskList)
                            return " " === t.match(u, !0)[1] ? i.taskOpen = !0 : i.taskClosed = !0,
                        ...
                        i.taskClosed = !1,
                        i.header && t.match(/^#+$/, !0))
                            return n.highlightFormatting && (i.formatting = "header"),
                            k(i);
                        var l = t.next();
                        if (i.linkTitle) {
                            i.linkTitle = !1;
                        ...
                        if ("!" === l && t.match(/\[[^\]]*\] ?(?:\(|\[)/, !1))
                            return i.imageMarker = !0,
                            i.image = !0,
                            n.highlightFormatting && (i.formatting = "image"),
                            k(i);
                        if ("[" === l && i.imageMarker && t.match(/[^\]]*\](\(.*?\)| ?\[.*?\])/, !1))
                            return i.imageMarker = !1,
                            i.imageAltText = !0,
                            n.highlightFormatting && (i.formatting = "image"),
                            k(i);
                        if ("]" === l && i.imageAltText) {
                            n.highlightFormatting && (i.formatting = "image");
                            var p = k(i);
                            return i.imageAltText = !1,
                            i.image = !1,
                            i.inline = i.f = T,
                            p
                        }
                        if ("[" === l && !i.image)
                            return i.linkText && t.match(/^.*?\]/) || (i.linkText = !0,
                        ...
                        if ("]" === l && i.linkText) {
                            ...
                            var p = k(i);
                            return i.linkText = !1,
                            i.inline = i.f = t.match(/\(.*?\)| ?\[.*?\]/, !1) ? T : S,
                            p
                        }
                        if ("<" === l && t.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1))
                            return i.f = i.inline = L,
                            n.highlightFormatting && (i.formatting = "link"),
                            (p = k(i)) ? p += " " : p = "",
                            p + o.linkInline;
                        if ("<" === l && t.match(/^[^> \\]+@(?:[^\\>]|\\.)+>/, !1))
                        ...
                        if (n.xml && "<" === l && t.match(/^\/\w*?>/))
                            return i.md_inside = !1,
                            "tag";
                        if ("*" === l || "_" === l) {
                            for (var w = 1, C = 1 == t.pos ? " " : t.string.charAt(t.pos - 2); w < 3 && t.eat(l); )
                                w++;
                            var M = t.peek() || " "
                              , N = !/\s/.test(M) && (!m.test(M) || /\s/.test(C) || m.test(C))
                              , A = !/\s/.test(C) && (!m.test(C) || /\s/.test(M) || m.test(M))
                              , D = null
                              , F = null;
                            if (w % 2 && (i.em || !N || "*" !== l && A && !m.test(C) ? i.em != l || !A || "*" !== l && N && !m.test(M) || (D = !1) : D = !0),
                            w > 1 && (i.strong || !N || "*" !== l && A && !m.test(C) ? i.strong != l || !A || "*" !== l && N && !m.test(M) || (F = !1) : F = !0),
                            null != F || null != D)
                                return n.highlightFormatting && (i.formatting = null == D ? "strong" : null == F ? "em" : "strong em"),
                                !0 === D && (i.em = l),
                                !0 === F && (i.strong = l),
                                f = k(i),
                                !1 === D && (i.em = !1),
                        ...
                        if (n.strikethrough)
                            if ("~" === l && t.eatWhile(l)) {
                                if (i.strikethrough)
                                    return n.highlightFormatting && (i.formatting = "strikethrough"),
                                    f = k(i),
                                    i.strikethrough = !1,
                                    f;
                                if (t.match(/^[^\s]/, !1))
                                    return i.strikethrough = !0,
                        ...
                        return " " === l && (t.match(/^ +$/, !1) ? i.trailingSpace++ : i.trailingSpace && (i.trailingSpaceNewLine = !0)),
                        k(i)
                    }
                    function L(e, t) {
                        if (">" === e.next()) {
        ...
        13: [function(e, t, n) {
            (function(e) {
                ...
                e.defineMode("xml", (function(r, i) {
                    var o, a, l = r.indentUnit, s = {}, u = i.htmlMode ? t : n;
                    for (var c in u)
                        s[c] = u[c];
                    for (var c in i)
                        s[c] = i[c];
                    function d(e, t) {
                        ...
                        var r = e.next();
                        return "<" == r ? e.eat("!") ? e.eat("[") ? e.match("CDATA[") ? n(f("atom", "]]>")) : null : e.match("--") ? n(f("comment", "--\x3e")) : e.match("DOCTYPE", !0, !0) ? (e.eatWhile(/[\w\._\-]/),
                        n(function e(t) {
                            return function(n, r) {
                                for (var i; null != (i = n.next()); ) {
                                    if ("<" == i)
                                        return r.tokenize = e(t + 1),
                                        r.tokenize(n, r);
                                    if (">" == i) {
                                        if (1 == t) {
                                            r.tokenize = d;
                        ...
                        t.tokenize = h,
                        "tag bracket") : "&" == r ? (e.eat("#") ? e.eat("x") ? e.eatWhile(/[a-fA-F\d]/) && e.eat(";") : e.eatWhile(/[\d]/) && e.eat(";") : e.eatWhile(/[\w\.\-:]/) && e.eat(";")) ? "atom" : "error" : (e.eatWhile(/[^&<]/),
                        null)
                    }
                    function h(e, t) {
                        var n, r, i = e.next();
                    ...
                    function y(e, t, n) {
                        if ("word" == e) {
                            var r = t.current();
                            return n.context && n.context.tagName != r && s.implicitlyClosed.hasOwnProperty(n.context.tagName) && m(n),
                            n.context && n.context.tagName == r || !1 === s.matchClosing ? (a = "tag",
                            b) : (a = "tag error",
                            w)
                        }
                    ...
                    function k(e, t, n) {
                        ...
                        if ("endTag" == e || "selfcloseTag" == e) {
                            ...
                            "selfcloseTag" == e || s.autoSelfClosers.hasOwnProperty(r) ? g(n, r) : (g(n, r),
                            n.context = new p(n,r,i == n.indented)),
                            v
                        }
                        return a = "error",
                        k
                    ...
                    function C(e, t, n) {
                        return "equals" == e ? S : (s.allowMissing || (a = "error"),
                        k(e, 0, n))
                    }
                    function S(e, t, n) {
                        return "string" == e ? L : "word" == e && s.allowUnquoted ? (a = "string",
                        k) : (a = "error",
                        k(e, 0, n))
                    }
                    function L(e, t, n) {
        ...
        14: [function(e, t, n) {
            !function(e, r) {
                ...
                var b = function(e, t) {
                  ...
                  , k = function(e, t, n) {
                    if (e) {
                        var r;
                        try {
                            r = decodeURIComponent(c(n)).replace(h, "").toLowerCase()
                        } catch (e) {
                            return null
                        }
                  ...
                  , A = function(e, t) {
                    ...
                    var n = {
                        replace: function(t, r) {
                            return r = (r = r.source || r).replace(d, "$1"),
                            e = e.replace(t, r),
                            n
                        },
                        getRegex: function() {
                ...
                F.def = A(F.def).replace("label", F._label).replace("title", F._title).getRegex(),
                F.bullet = /(?:[*+-]|\d{1,9}\.)/,
                F.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/,
                F.item = A(F.item, "gm").replace(/bull/g, F.bullet).getRegex(),
                F.list = A(F.list).replace(/bull/g, F.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + F.def.source + ")").getRegex(),
                F._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
                F._comment = /<!--(?!-?>)[\s\S]*?-->/,
                F.html = A(F.html, "i").replace("comment", F._comment).replace("tag", F._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
                F.paragraph = A(F._paragraph).replace("hr", F.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", F._tag).getRegex(),
                F.blockquote = A(F.blockquote).replace("paragraph", F.paragraph).getRegex(),
                F.normal = D({}, F),
                F.gfm = D({}, F.normal, {
                ...
                F.gfm.table = A(F.gfm.table).replace("hr", F.hr).replace("heading", " {0,3}#{1,6} ").replace("blockquote", " {0,3}>").replace("code", " {4}[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", F._tag).getRegex(),
                F.pedantic = D({}, F.normal, {
                ...
                E.em = A(E.em).replace(/punctuation/g, E._punctuation).getRegex(),
                E._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,
                ...
                E.autolink = A(E.autolink).replace("scheme", E._scheme).replace("email", E._email).getRegex(),
                E._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,
                E.tag = A(E.tag).replace("comment", F._comment).replace("attribute", E._attribute).getRegex(),
                E._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,
                E._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/,
                E._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
                E.link = A(E.link).replace("label", E._label).replace("href", E._href).replace("title", E._title).getRegex(),
                E.reflink = A(E.reflink).replace("label", E._label).getRegex(),
                E.normal = D({}, E),
                E.pedantic = D({}, E.normal, {
                    strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,
                    em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/,
                    link: A(/^!?\[(label)\]\((.*?)\)/).replace("label", E._label).getRegex(),
                    reflink: A(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", E._label).getRegex()
                }),
                E.gfm = D({}, E.normal, {
                    escape: A(E.escape).replace("])", "~|])").getRegex(),
                ...
                E.gfm.url = A(E.gfm.url, "i").replace("email", E.gfm._extended_email).getRegex(),
                E.breaks = D({}, E.gfm, {
                    br: A(E.br).replace("{2,}", "*").getRegex(),
                    text: A(E.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
                });
                var O = {
                    block: F,
                    inline: E
                  ...
                  , W = function() {
                    function e(e) {
                        ...
                        this.options = e || I,
                        this.rules = z.normal,
                        this.options.pedantic ? this.rules = z.pedantic : this.options.gfm && (this.rules = z.gfm)
                    }
                    e.lex = function(t, n) {
                    ...
                    ,
                    n.token = function(e, t) {
                        var n, r, i, o, a, l, s, u, c, d, h, f, p, m, g, v;
                        for (e = e.replace(/^ +$/gm, ""); e; )
                            ...
                            i = this.rules.code.exec(e)) {
                                ...
                                this.tokens.push({
                                    ...
                                    text: this.options.pedantic ? i : H(i, "\n")
                                }))
                                ...
                                for (h = 0; h < l.cells.length; h++)
                                    l.cells[h] = P(l.cells[h], l.header.length);
                                this.tokens.push(l)
                                ...
                                h = 0; h < p; h++)
                                    ...
                                    l = this.options.pedantic ? l.replace(/^ {1,4}/gm, "") : l.replace(new RegExp("^ {1," + d + "}","gm"), "")),
                                    h !== p - 1 && (a = z.bullet.exec(i[h + 1])[0],
                                    (o.length > 1 ? 1 === a.length : a.length > 1 || this.options.smartLists && a !== o) && (e = i.slice(h + 1).join("\n") + e,
                                    h = p - 1)),
                                    r = n || /\n\n(?!\s*$)/.test(l),
                                    h !== p - 1 && (n = "\n" === l.charAt(l.length - 1),
                                    r || (r = n)),
                                ...
                                h = 0; h < l.align.length; h++)
                                    /^ *-+: *$/.test(l.align[h]) ? l.align[h] = "right" : /^ *:-+: *$/.test(l.align[h]) ? l.align[h] = "center" : /^ *:-+ *$/.test(l.align[h]) ? l.align[h] = "left" : l.align[h] = null;
                                for (h = 0; h < l.cells.length; h++)
                                    l.cells[h] = P(l.cells[h].replace(/^ *\| *| *\| *$/g, ""), l.header.length);
                                this.tokens.push(l)
                  ...
                  , q = function() {
                    ...
                    return t.code = function(e, t, n) {
                        ...
                        return r ? '<pre><code class="' + this.options.langPrefix + j(r, !0) + '">' + (n ? e : j(e, !0)) + "</code></pre>\n" : "<pre><code>" + (n ? e : j(e, !0)) + "</code></pre>"
                    }
                    ,
                  ...
                  , X = function() {
                    ...
                    e.output = function(t, n, r) {
                        return new e(n,r).output(t)
                    }
                    ;
                    var n = e.prototype;
                    return n.output = function(t) {
                        for (var n, r, i, o, a, l, s = ""; t; )
                            if (a = this.rules.escape.exec(t))
                                ...
                                t = t.substring(a[0].length),
                                s += this.renderer.html(this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : K(a[0]) : a[0]);
                            else if (a = this.rules.link.exec(t)) {
                                var u = V(a[2], "()");
                                if (u > -1) {
                                    var c = (0 === a[0].indexOf("!") ? 5 : 4) + a[1].length + u;
                                ...
                                this.inLink = !0,
                                i = a[2],
                                this.options.pedantic ? (n = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i)) ? (i = n[1],
                                o = n[3]) : o = "" : o = a[3] ? a[3].slice(1, -1) : "",
                                ...
                                t = t.substring(a[0].length),
                                s += this.renderer.codespan(K(a[2].trim(), !0));
                                ...
                                t = t.substring(a[0].length),
                                i = "@" === a[2] ? "mailto:" + (r = K(this.mangle(a[1]))) : r = K(a[1]),
                                s += this.renderer.link(i, null, r);
                            else if (this.inLink || !(a = this.rules.url.exec(t))) {
                                if (a = this.rules.text.exec(t))
                                    t = t.substring(a[0].length),
                                    this.inRawBlock ? s += this.renderer.text(this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : K(a[0]) : a[0]) : s += this.renderer.text(K(this.smartypants(a[0])));
                                else if (t)
                  ...
                  , ee = function() {
                    ...
                    return t.parse = function(e) {
                        this.inline = new X(e.links,this.options),
                        this.inlineText = new X(e.links,Q({}, this.options, {
                            renderer: new Z
                        })),
                    ...
                    t.tok = function() {
                        ...
                        case "heading":
                            return this.renderer.heading(this.inline.output(this.token.text), this.token.depth, J(this.inlineText.output(this.token.text)), this.slugger);
                        case "code":
                        ...
                        case "table":
                            ...
                            for (o += this.renderer.tablerow(r),
                            t = 0; t < this.token.cells.length; t++) {
                                for (n = this.token.cells[t],
                                r = "",
                                i = 0; i < n.length; i++)
                                    r += this.renderer.tablecell(this.inline.output(n[i]), {
                                        header: !1,
                        ...
                        case "list_start":
                            e = "";
                            for (var a = this.token.ordered, l = this.token.start; "list_end" !== this.next().type; )
                                e += this.tok();
                            ...
                            if (this.token.task)
                                if (s)
                                    if ("text" === this.peek().type) {
                                        var d = this.peek();
                                        d.text = this.renderer.checkbox(u) + " " + d.text
                                    } else
                                        this.tokens.push({
                                            type: "text",
                                    ...
                                    e += this.renderer.checkbox(u);
                            for (; "list_item_end" !== this.next().type; )
                                e += s || "text" !== this.token.type ? this.tok() : this.parseText();
                            return this.renderer.listitem(e, c, u);
                        case "html":
                ...
                function le(e, t, n) {
                            ...
                            for (; a < r.length; a++)
                                !function(e) {
                                    "code" !== e.type ? --i || l() : o(e.text, e.lang, (function(t, n) {
                                        return t ? l(t) : null == n || n === e.text ? --i || l() : (e.text = n,
                                        e.escaped = !0,
                                        void (--i || l()))
                                    }
                                    ))
                    ...
                    try {
                        return t = te({}, le.defaults, t || {}),
                        ne(t),
                        ee.parse(W.lex(e, t), t)
                    } catch (e) {
                        if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
                        (t || le.defaults).silent)
                            return "<p>An error occurred:</p><pre>" + re(e.message + "", !0) + "</pre>";
                        throw e
                    }
                }
                return le.options = le.setOptions = function(e) {
                    return te(le.defaults, e),
                    oe(le.defaults),
                    le
                }
                ,
            ...
            (function(n) {
                ...
                !function() {
                    ...
                    (r = function(e, t, r, i) {
                        ...
                        t && r ? p() : "undefined" != typeof window && "chrome"in window && "extension"in window.chrome && "getURL"in window.chrome.extension ? (o = i.dictionaryPath ? i.dictionaryPath : "typo/dictionaries",
                        t || d(chrome.extension.getURL(o + "/" + e + "/" + e + ".aff"), h),
                        r || d(chrome.extension.getURL(o + "/" + e + "/" + e + ".dic"), f)) : (o = i.dictionaryPath ? i.dictionaryPath : void 0 !== n ? n + "/dictionaries" : "./dictionaries",
                        t || d(o + "/" + e + "/" + e + ".aff", h),
                        r || d(o + "/" + e + "/" + e + ".dic", f))),
                        this
                    }
                        ...
                        _readFile: function(t, n, r) {
                            ...
                            "undefined" != typeof XMLHttpRequest) {
                                ...
                                return o.open("GET", t, r),
                                r && (i = new Promise((function(e, t) {
                                    o.onload = function() {
                        ...
                        _parseAFF: function(e) {
                            var t, n, r, i, o, a, l, s = {}, u = (e = this._removeAffixComments(e)).split(/\r?\n/);
                            for (i = 0,
                            a = u.length; i < a; i++) {
                                var c = (t = u[i]).split(/\s+/)
                                  , d = c[0];
                                if ("PFX" == d || "SFX" == d) {
                                    ...
                                    for (o = i + 1,
                                    l = i + 1 + (n = parseInt(c[1], 10)); o < l; o++)
                                        r = (t = u[o]).split(/\s+/),
                                        this.compoundRules.push(r[1]);
                                    i += n
                                } else
                                    "REP" === d ? 3 === (r = t.split(/\s+/)).length && this.replacementTable.push([r[1], r[2]]) : this.flags[d] = c[1]
                            }
                            return s
                        },
                            ...
                            function s(e, t) {
                                ...
                                for (var u in e)
                                    ...
                                    i = u.length + 1; n < i; n++) {
                                        ...
                                        if (c[1] && (a = c[0] + c[1].substring(1),
                                        t && !l.check(a) || (a in s ? s[a] += 1 : s[a] = 1)),
                                        c[1].length > 1 && c[1][1] !== c[1][0] && (a = c[0] + c[1][1] + c[1][0] + c[1].substring(2),
                                        t && !l.check(a) || (a in s ? s[a] += 1 : s[a] = 1)),
                                        c[1])
                                            for (r = 0,
                                            o = l.alphabet.length; r < o; r++)
                                                l.alphabet[r] != c[1].substring(0, 1) && (a = c[0] + l.alphabet[r] + c[1].substring(1),
                                                t && !l.check(a) || (a in s ? s[a] += 1 : s[a] = 1));
                                        if (c[1])
                                            for (r = 0,
                                            o = l.alphabet.length; r < o; r++)
                                                a = c[0] + l.alphabet[r] + c[1],
                                                t && !l.check(a) || (a in s ? s[a] += 1 : s[a] = 1)
                                    }
                                return s
                            }
        ...
        17: [function(e, t, n) {
            ...
            function h(e, t, n, r) {
                ...
                for (var a = 0; a < e.children.length; a++) {
                    ...
                    l = f("string" == typeof s && s in K ? K[s] : s, !0, t, n, "button", r),
                    o.appendChild(l)
                }
            ...
            function m(e, t) {
                ...
                for (var r, i, o = n.type.split(" "), a = {}, l = 0; l < o.length; l++)
                    "strong" === (r = o[l]) ? a.bold = !0 : "variable-2" === r ? (i = e.getLine(t.line),
            ...
            function v(e) {
                ...
                if (/fullscreen/.test(n.previousSibling.className) ? n.previousSibling.className = n.previousSibling.className.replace(/\s*fullscreen\b/, "") : n.previousSibling.className += " fullscreen",
                ...
                /editor-preview-active-side/.test(i.className) && R(e),
            ...
            function w(e) {
                ...
                var o, a, l, s = e.codemirror, u = s.getCursor("start"), c = s.getCursor("end"), d = s.getTokenAt({
                    line: u.line,
                    ch: u.ch || 1
                }), h = s.getLineHandle(u.line), f = i(s, u.line, h, d);
                if ("single" === f) {
                    ...
                    if (u.line !== c.line || u.ch !== c.ch) {
                        ...
                        var w = u.line;
                        if (n(s.getLineHandle(u.line)) && ("fenced" === i(s, u.line + 1) ? (o = u.line,
                        w = u.line + 1) : (a = u.line,
                        w = u.line - 1)),
                        void 0 === o)
                        ...
                        if (void 0 === a)
                            for (l = s.lineCount(),
                            a = w; a < l && !n(h = s.getLineHandle(a)); a++)
                                ;
                        s.operation((function() {
                            s.replaceRange("", {
                                line: o,
            ...
            function O(e, t) {
                ...
                _(n, r.image, i.insertTexts.uploadedImage, t),
            ...
            function R(e) {
                ...
                if (/editor-preview-active/.test(a.className)) {
                    ...
                    s.className = s.className.replace(/\s*disabled-for-preview*/g, "")
                }
            ...
            function W(e) {
                ...
                if (!o || !/editor-preview-full/.test(o.className)) {
                    ...
                    e.options.previewClass)
                        if (Array.isArray(e.options.previewClass))
                            ...
                            "string" == typeof e.options.previewClass && (o.className += " " + e.options.previewClass);
                    n.appendChild(o)
                }
                ...
                /editor-preview-active-side/.test(l.className) && R(e)
            }
            function _(e, t, n, r) {
                if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className)) {
                    var i, o = n[0], a = n[1], l = {}, s = {};
                    Object.assign(l, e.getCursor("start")),
                    Object.assign(s, e.getCursor("end")),
                    r && (o = o.replace("#url#", r),
                    a = a.replace("#url#", r)),
                    t ? (o = (i = e.getLine(l.line)).slice(0, l.ch),
                    a = i.slice(l.ch),
                    e.replaceRange(o + a, {
                        line: l.line,
                        ch: 0
                ...
                if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className)) {
                    for (var r = e.getCursor("start"), i = e.getCursor("end"), o = r.line; o <= i.line; o++)
                        !function(r) {
                            var i = e.getLine(r)
                              , o = i.search(/[^#]/);
                            i = void 0 !== t ? o <= 0 ? "bigger" == t ? "###### " + i : "# " + i : 6 == o && "smaller" == t ? i.substr(7) : 1 == o && "bigger" == t ? i.substr(2) : "bigger" == t ? i.substr(1) : "#" + i : 1 == n ? o <= 0 ? "# " + i : o == n ? i.substr(o + 1) : "# " + i.substr(o + 1) : 2 == n ? o <= 0 ? "## " + i : o == n ? i.substr(o + 1) : "## " + i.substr(o + 1) : o <= 0 ? "### " + i : o == n ? i.substr(o + 1) : "### " + i.substr(o + 1),
                            e.replaceRange(i, {
                                line: r,
                                ch: 0
                            }, {
            ...
            function j(e, t) {
                if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className)) {
                    for (var n = /^(\s*)(\*|-|\+|\d*\.)(\s+)/, r = /^\s*/, i = m(e), o = e.getCursor("start"), a = e.getCursor("end"), l = {
                        ...
                        t = o[1] + a + o[3] + t.replace(r, "").replace(l[e], "$1")) : 0 == i && (t = a + " " + t),
                        t
                    }, u = 1, c = o.line; c <= a.line; c++)
                        !function(n) {
                            var r = e.getLine(n);
                            i[t] ? r = r.replace(l[t], "$1") : ("unordered-list" == t && (r = s("ordered-list", r, !0)),
                            r = s(t, r, !1),
                            u += 1),
                            e.replaceRange(r, {
                                line: n,
            ...
            function q(e, t, n, r) {
                if (!/editor-preview-active/.test(e.codemirror.getWrapperElement().lastChild.className)) {
                    ...
                    u !== c && (c.ch -= 1))) : (i = o.getSelection(),
                    "bold" == t ? i = (i = i.split("**").join("")).split("__").join("") : "italic" == t ? i = (i = i.split("*").join("")).split("_").join("") : "strikethrough" == t && (i = i.split("~~").join("")),
            ...
            function U(e, t) {
                ...
                do {
                    e /= 1024,
                    ++n
                } while (Math.abs(e) >= 1024 && n < t.length);return "" + e.toFixed(1) + t[n]
            }
            function $(e, t) {
                for (var n in t)
                    Object.prototype.hasOwnProperty.call(t, n) && (t[n]instanceof Array ? e[n] = t[n].concat(e[n]instanceof Array ? e[n] : []) : null !== t[n] && "object" == typeof t[n] && t[n].constructor === Object ? e[n] = $(e[n] || {}, t[n]) : e[n] = t[n]);
                return e
            }
            function G(e) {
            ...
            function te(e) {
                ...
                if (void 0 === e.toolbar)
                    ...
                    K)
                        Object.prototype.hasOwnProperty.call(K, o) && (-1 != o.indexOf("separator-") && e.toolbar.push("|"),
                ...
                e.insertTexts = G({}, X, e.insertTexts || {}),
                e.promptTexts = G({}, Z, e.promptTexts || {}),
                e.blockStyles = G({}, Q, e.blockStyles || {}),
                null != e.autosave && (e.autosave.timeFormat = G({}, Y, e.autosave.timeFormat || {})),
                e.shortcuts = G({}, u, e.shortcuts || {}),
                ...
                e.imageTexts = G({}, J, e.imageTexts || {}),
                e.errorMessages = G({}, ee, e.errorMessages || {}),
            ...
            te.prototype.markdown = function(e) {
                if (o) {
                    ...
                    o.setOptions(t);
                    var r = o(e);
                    return this.options.renderingConfig && "function" == typeof this.options.renderingConfig.sanitizerFunction && (r = this.options.renderingConfig.sanitizerFunction.call(this, r)),
                    r = function(e) {
            ...
            te.prototype.autosave = function() {
                if (ne()) {
                    ...
                    !0 !== this.options.autosave.binded && (null != e.element.form && null != e.element.form && e.element.form.addEventListener("submit", (function() {
                        ...
                        ), e.options.autosave.submit_delay || e.options.autosave.delay || 1e4)
                    }
                    )),
            ...
            te.prototype.uploadImage = function(e, t, n) {
                ...
                e.size > this.options.imageMaxSize)
                    ...
                    var a = new FormData;
                    a.append("image", e),
                    r.options.imageCSRFToken && a.append("csrfmiddlewaretoken", r.options.imageCSRFToken);
                    ...
                    l.onload = function() {
                        ...
                        200 === this.status && e && !e.error && e.data && e.data.filePath ? t(window.location.origin + "/" + e.data.filePath) : e.error && e.error in r.options.errorMessages ? i(o(r.options.errorMessages[e.error])) : e.error ? i(o(e.error)) : (console.error("EasyMDE: Received an unexpected response after uploading the image." + this.status + " (" + this.statusText + ")"),
                ...
                if (!n || !/editor-preview-side/.test(n.className)) {
                    ...
                    this.options.previewClass)
                        if (Array.isArray(this.options.previewClass))
                            ...
                            "string" == typeof this.options.previewClass && (n.className += " " + this.options.previewClass);
                    t.parentNode.insertBefore(n, t.nextSibling)
                }
                if (!1 === this.options.syncSideBySidePreviewScroll)
                    return n;
                var i = !1
                  , o = !1;
                ...
                if ((e = e || this.options.toolbar) && 0 !== e.length) {
                    ...
                    t = 0; t < e.length; t++)
                        if (("guide" != e[t].name || !1 !== r.options.toolbarGuideIcon) && !(r.options.hideIcons && -1 != r.options.hideIcons.indexOf(e[t].name) || ("fullscreen" == e[t].name || "side-by-side" == e[t].name) && c())) {
                            ...
                            !function(e) {
                                var t;
                                if (t = "|" === e ? p() : e.children ? h(e, r.options.toolbarTips, r.options.shortcuts, r) : f(e, !0, r.options.toolbarTips, r.options.shortcuts, "button", r),
                                i[e.name || e] = t,
                                n.appendChild(t),
                                "upload-image" === e.name) {
            ...
            te.prototype.createStatusbar = function(e) {
                ...
                if (e && 0 !== e.length) {
                    ...
                    r = 0; r < a.length; r++) {
                        ...
                        c.className = u.className,
                        "function" == typeof u.defaultValue && u.defaultValue(c),
                        "function" == typeof u.onUpdate && this.codemirror.on("update", function(e, t) {
                            return function() {
                                t.onUpdate(e)
                            }
                        }(c, u)),
            ...
            te.toggleBold = x,
            te.toggleItalic = y,
            te.toggleStrikethrough = b,
            te.toggleBlockquote = k,
            te.toggleHeadingSmaller = C,
            te.toggleHeadingBigger = S,
            te.toggleHeading1 = L,
            te.toggleHeading2 = T,
            te.toggleHeading3 = M,
            te.toggleCodeBlock = w,
            te.toggleUnorderedList = N,
            te.toggleOrderedList = A,
            te.cleanBlock = D,
            te.drawLink = F,
            te.drawImage = E,
            te.drawTable = I,
            te.drawHorizontalRule = z,
            te.undo = H,
            te.redo = P,
            te.togglePreview = W,
            te.toggleSideBySide = R,
            te.toggleFullScreen = v,
